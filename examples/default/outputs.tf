output "efs_file_system_arn" {
  ...
  value       = module.efs_default.file_system_arn
}
...
output "efs_file_system_owner_id" {
  ...
  value       = module.efs_default.file_system_owner_id
}
...
output "efs_file_system_size_in_bytes" {
  ...
  value       = module.efs_default.file_system_size_in_bytes
}

output "efs_access_points_arns" {
  description = "ARN(s) of the access point(s)"
  value       = module.efs_default.access_points_arns
}
...
output "efs_mount_targets_network_interface_ids" {
  ...
  value       = module.efs_default.mount_targets_network_interface_ids
}
...
output "efs_mount_targets_availability_zone_names" {
  ...
  value       = module.efs_default.mount_targets_availability_zone_names
}
...
output "efs_replication_configuration_destination_status" {
  ...
  value       = module.efs_default.replication_configuration_destination_status
}
...
output "efs_replication_configuration_original_source_file_system_arn" {
  ...
  value       = module.efs_default.replication_configuration_original_source_file_system_arn
}
...
output "efs_replication_configuration_source_file_system_arn" {
  ...
  value       = module.efs_default.replication_configuration_source_file_system_arn
}
...
output "efs_replication_configuration_source_file_system_region" {
  ...
  value       = module.efs_default.replication_configuration_source_file_system_region
}

output "tags_all" {
  description = "A map of tags assigned to the resource"
  value       = module.efs_default.tags_all
}
